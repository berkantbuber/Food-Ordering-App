...
import com.example.ourplace.databinding.ActivitySingupBinding;
...
public class SingupActivity extends BaseActivity {
    ...
    private void setVaribale() {
        binding.singupBtn.setOnClickListener(v -> {
            ...
            {
                Toast.makeText(SingupActivity.this, "Şifreniz 6 karakterden uzun olmalı", Toast.LENGTH_SHORT).show();
                return;
            }
